...
function Home(props) {
    ...
    const [modes,setModes] = useState(["Online","Offline","Both"]);
    const [releasetypes,setReleasetypes] = useState(["Dev","Staging","Production"]);
    const [purposes,setPurposes] = useState(["Object Detection","Segmentation","Classification"]);
    const [languages,setLanguages] = useState(["Lang1","Lang2","Lang3","Lang4","Lang5"]);
